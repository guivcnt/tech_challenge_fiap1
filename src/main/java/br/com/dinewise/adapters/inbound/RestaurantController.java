...
public class RestaurantController {
    ...
    @PostMapping
    public ResponseEntity<DineWiseResponse> create(@RequestBody RestaurantRequest request) throws DineWiseResponseError {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Optional<RestaurantEntity>> get(@PathVariable Long id) throws DineWiseResponseError {
        return this.service.get(id);
    }

    @PutMapping("/{id}")
    public ResponseEntity<DineWiseResponse> update(@PathVariable Long id, @RequestBody RestaurantRequest request) throws DineWiseResponseError {
